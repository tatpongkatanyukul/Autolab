...
def makeandgrade(policy_par):
    ...
    student_score = numtol_policy2(policy_par["student"], ref_txt, 
        int(policy_par['score']), policy_par["mode"], float(cfg["numtol"]), neg_handling=True)
