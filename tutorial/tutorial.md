...
## General idea of Autograder
  ...
  * Autolab does not care about how our autograder runs (or our grading policy). It only cares about the last line we print out, because that is supposed to be a score report.
